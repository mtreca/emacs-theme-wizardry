;;; wizardry-theme.el --- A Light Theme For Emacs Wizards -*- lexical-binding: t; -*-
...
;; URL: http://github.com/vxid/emacs-theme-wizardry
...
(autothemer-deftheme
 wizardry "Wizardry - A Light Theme For Emacs Wizards"
 ...
 ((((class color) (min-colors #xFFFFFF)))
  ...
  (region                     (:foreground bg :background fg))
  (secondary-selection        (:foreground bg :background c8))
  ...
  (vertical-border            (:foreground fg :background bg))
  (window-divider             (:foreground fg :background bg))
  (window-divider-first-pixel (:foreground fg :background bg))
...

  ...
  (ivy-minibuffer-match-highlight  (:underline t))
  ...
  (ivy-remote                      (:slant 'italic))
  (ivy-separator                   (:foreground c7))
  (ivy-subdir                      (:foreground fg :weight 'bold))
  (ivy-virtual                     (:foreground fg :slant 'italic))
...

  ...
  (custom-theme-set-variables 'wizardry
...
(provide-theme 'wizardry)

;;; wizardry-theme.el ends here
